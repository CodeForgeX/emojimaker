  ...
  return (
    <>
      ...
      <main
        ...
        max-w="65ch" max-h="[calc(100vh-2rem)]" overflow-y-auto
        px-6 py-6
      ...
      >
        <div flex items-center justify-center w="160px" h="160px" border-2 border-neutral-400 border-op-20 rounded-2xl>
          <canvas ref={canvas} width={canvasSize} height={canvasSize} w="128px" h="128px" class="animation"></canvas>
        </div>
        <div flex h-12 gap-2>
          <button
        ...
        <div w-full mt-4>
          <header flex flex-wrap items-center gap-2 p-3 border-b border-neutral-400 border-op-20 justify-center>
            <For each={tabs}>
              {(item, index) => (
                <button
                ...
                >
                  ...
                  >
                    <img src={selectedImage()[item]} alt={selectedTab() + index()} h-8 w-8></img>
                  </Show>
                </button>
              )}
            </For>
          </header>
          <main p-3 max-h="[30vh]" overflow-y-auto>
